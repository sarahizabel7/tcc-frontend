...
import { Button, Col, Modal, RadioGroup, Row } from 'react-materialize';
import { PulseLoader } from 'react-spinners';

import { useCpf, useInput } from '../../hooks/Form';
import { Gender, ProviderInterface } from '../../interfaces/commonInterfaces';
...
export default (props: OwnProps) => {
  ...
  const hasError = () => {
    ...
    return Boolean(phoneError) || Boolean(cpfError);
  };
